...
if __name__ == '__main__':
    ...
    parser.add_argument('--env_name', type=str, default='apex-fx', help='Environment of Atari2600 games')
    ...
    parser.add_argument('--lstm', type=int, default=0, help='using lstm')
    parser.add_argument('--train_start', type=str, default='20180213', help='train starting date')
    parser.add_argument('--train_end', type=str, default='20180711', help='train ending date')
    parser.add_argument('--test_start', type=str, default='20180722', help='test(valid) starting date')
    parser.add_argument('--test_end', type=str, default=None, help='test(valid) ending date')
    parser.add_argument('--test_epsilon', type=float, default=0.0, help='epsilon when test')
    ...
    # Test Mode
        ...
        for episode in range(10):
            ...
            while not terminal:
                ...
                next_state, reward, terminal = agent.env.step(action)
                # if args.test_gui:
                #     env.render()
